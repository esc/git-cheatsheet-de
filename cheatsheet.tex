...
\draw[->,thick] (r.south) .. controls +(0,-1.4) and +(0,-1.4) .. node[fill=green!50,below=1pt]{checkout} (w.south);
  ...
  ++(8.5cm,0) node[below right,text width=10.3cm,rounded corners,fill=gray!15,inner sep=1ex,drop shadow]
  {
  ...
  ++(0,-2.2cm) node[below right,text width=10.3cm,rounded corners,fill=gray!15,inner sep=1ex,drop shadow]
  {
  ...
  ++(0,-3.0cm) node[below right,text width=10.3cm,rounded corners,fill=gray!15,inner sep=1ex,drop shadow]
  {
